...
Don't use expo (you are tying yourself to a cloud build environment):
...
* Importing libraries / hot reload.
Setting up hot reloading
https://github.com/practicalli/clojure-deps-edn/#hotload-libraries-into-a-running-repl
...
** Protocols in the JVM! Must watch https://www.youtube.com/watch?v=kQhOlWXXl2I
** Protocols and deftype in clojure https://looselytyped.com/blog/2013/07/31/on-sortieing-to-clojure-land-a-brief-overview-of-protocols-records-and-reify/
...
* Data Science
** TODO Deep diamond https://dragan.rocks/articles/22/Recurrent-networks-hello-world-sequence-prediction-in-Clojure-with-new-Deep-Diamond
* Babashka
...
** CLJS gotchas
   ...
   https://stackoverflow.com/questions/53149344/what-causes-error-no-protocol-method-xxx-yyy-defined-for-type-undefined-in-cl
...
** <2022-12-10 Sat> https://lambdaisland.com/blog/2017-02-11-re-frame-form-1-subscriptions
** <2022-12-10 Sat> https://lambdaisland.com/episodes/re-frame-subscriptions
...
** Making Java classes sequenceable
<2022-10-26 Wed> Interestin read https://wallace.fm/blog/2016/byod-party/
<2022-10-26 Wed> Seq vs sequable: cljs vs clj  https://lambdaisland.com/episodes/clojure-seq-seqable
<2022-10-26 Wed> dynamic vs static? https://kotka.de/blog/2010/08/Static_vs_Dynamic.html
<2022-10-26 Wed> Nope, not for clojure https://www.mail-archive.com/clojure@googlegroups.com/msg48522.html
...
#+end_src
* Code snippets
** Find out git deps https://github.com/babashka/neil
#+begin_src  bash
  neil dep add --latest-sha true --dry-run https://gist.github.com/adam-james-v/6b2ee824d0040b82f91dbdd1f7fd5330
#+end_src
** Import git dependency https://clojure.org/guides/deps_and_cli#_using_git_libraries
** Import local source dep https://clojure.org/guides/deps_and_cli#prep_libs
...
* Tools + libs
** Libpython
<2023-08-07 Mon> https://github.com/gigasquid/libpython-clj-examples/blob/master/src/gigasquid/gpt2.clj

<2023-08-07 Mon> https://github.com/clj-python/libpython-clj/blob/master/topics/Usage.md

<2023-08-14 Mon> Chris Nuernberg demo  https://youtu.be/ajDiGS73i2o?t=964 (I had watched this months earlier)
#+begin_src clojure
  ;; from ... import ...
  (py/from-import)

  ;; os.environ['USE_TORCH'] = '1'
  (py/set-attr! os/environ "USE_TORCH" "1")

  (py/get-attr os/environ "USE_TORCH") ;; => "1"
  (System/getenv "USE_TORCH") ;; => nil     interesting!
  ...
  ;; inspect obj
  (py/dir x)
  ;; https://github.com/clj-python/libpython-clj/issues/215
  (libpython-clj2.metadata/vars x)
  (libpython-clj2.metadata/type x)



#+end_src
** Babashka + HTMX https://github.com/keychera/panas.example
** Portfolio storybook equivalent https://github.com/cjohansen/portfolio https://www.youtube.com/watch?v=25JDQRFoQ_U
** Overtone /sound
*** TODO Piratidal https://www.youtube.com/watch?v=7qNSjhMf_HU
*** TODO SuperCollider: No matching method sleep

https://github.com/overtone/overtone/issues/497

#+begin_src
  --> Booting internal SuperCollider server...
Exception in thread "Thread-22" java.lang.NullPointerException: Cannot invoke "clojure.lang.IFn.invoke()"
	...
	at overtone.sc.machinery.server.connection$boot_internal_server$fn__20597.invoke(connection.clj:225)
	at clojure.lang.AFn.run(AFn.java:22)
	at java.base/java.lang.Thread.run(Thread.java:1589)
Syntax error (IllegalArgumentException) compiling at (overtone/live.clj:7:1).
No matching method sleep found taking 1 args
#+end_src
*** DONE FileNotFoundException in badigeno
CLOSED: [2023-04-02 Sun 17:54]
#+begin_src
  --> Loading Overtone...
Syntax error (FileNotFoundException) compiling at (badigeon/bundle.clj:1:1).
...
neil dep add overtone/overtone --latest-sha true

** XTDB alternative https://github.com/juji-io/datalevin
** TODO Discussion on indenting consistency https://clojurians.slack.com/archives/C03RZGPG3/p1678921877459829
** Refx: Reframe for UIX https://github.com/ferdinand-beyer/refx
** Hyperfiddle UI modelling https://www.hyperfiddle.net/
** bubble gum text ui https://github.com/lispyclouds/bblgum
** Robot https://github.com/D00mch/robot
** HumbleUI

#+begin_src clojure

(comment
  "I didn't understand what you meant by viewport, but it's clear you mean to pass the viewport rect
from VScroll to Column (assuming that's what's being wrapped). I didn't know before that Column had no clue about what section of it was being drawn, and so it draws all rows! Actually I'm impressed with how quickly the framework draws given it is not
only drawing the viewport!


The complication is that Column needs to query the state of VScroll to understand the viewport dimentions.

TODO
Rather than fundamentally change the -draw protocol to always pass the viewport, I combined VScroll and Column into VColumn.


TODO
I dont' understand why the clip-rect is soo long in the vertical!
I imagine the child rect is 



Vscroll is doing two jobs: Clip and Transform.
It should only do Clip, and act on a ITransform.
...
"
  ...
  (def ui
    (ui/default-theme
     ...
     (ui/column
      (ui/vscrollbar
       (ui/column ;; has the ability to flatten clojure containers.
        (take 100
              (cycle
               [(ui/gap 0 10)
                (ui/label "Line xyz")]))))
      [:stretch 1 nil]
      (ui/label "Bottom row 1") ;; These lines are overwritten by the vscrollbar and vscroll and children.
      (ui/label "Bottom row 2"))))

  (- 2147483647 2147476631))
  
;; [desktop_ui_extra.VScroll _draw "NO_SOURCE_FILE" 88]
  ;; [io.github.humbleui.core$draw invokeStatic "core.clj" 548]
  ;; [io.github.humbleui.core$draw invoke "core.clj" 546]
  ;; [io.github.humbleui.core$draw_child invokeStatic "core.clj" 554]
  ;; [io.github.humbleui.core$draw_child invoke "core.clj" 550]
  ;; [desktop_ui_extra.VScrollbar _draw "NO_SOURCE_FILE" 51]
  ;; [io.github.humbleui.core$draw invokeStatic "core.clj" 548]
  ;; [io.github.humbleui.core$draw invoke "core.clj" 546]
  ;; [io.github.humbleui.core$draw_child invokeStatic "core.clj" 554]
  ;; [io.github.humbleui.core$draw_child invoke "core.clj" 550]
  ;; [io.github.humbleui.ui.containers.Column$fn__14000 invoke "containers.clj" 23]
  ...
  ;; [io.github.humbleui.ui.containers.Column _draw "containers.clj" 23]
  ;; [io.github.humbleui.core$draw invokeStatic "core.clj" 548]
  ;; [io.github.humbleui.core$draw invoke "core.clj" 546]
  ;; [io.github.humbleui.core$draw_child invokeStatic "core.clj" 554]
  ;; [io.github.humbleui.core$draw_child invoke "core.clj" 550]
  ;; [io.github.humbleui.ui.dynamic.Contextual _draw "dynamic.clj" 12]
  ;; [io.github.humbleui.core$draw invokeStatic "core.clj" 548]
  ;; [io.github.humbleui.core$draw invoke "core.clj" 546]
  ;; [io.github.humbleui.core$draw_child invokeStatic "core.clj" 554]
  ;; [io.github.humbleui.core$draw_child invoke "core.clj" 550]
  ;; [io.github.humbleui.ui.with_context.WithContext _draw "with_context.clj" 8]
  ;; [io.github.humbleui.core$draw invokeStatic "core.clj" 548]
  ;; [io.github.humbleui.core$draw invoke "core.clj" 546]
  ;; [io.github.humbleui.core$draw_child invokeStatic "core.clj" 554]
  ;; [io.github.humbleui.core$draw_child invoke "core.clj" 550]
  ...
  ;; [io.github.humbleui.core$draw invokeStatic "core.clj" 548]
  ;; [io.github.humbleui.core$draw invoke "core.clj" 546]
  ;; [io.github.humbleui.ui.window$window$paint_fn__15345 invoke "window.clj" 35]
  ;; [io.github.humbleui.window$make$reify__13614$fn__13620 invoke "window.clj" 83]
  ;; [io.github.humbleui.window$make$reify__13614 accept "window.clj" 81]
  ;; [io.github.humbleui.jwm.Window accept "Window.java" 393]
  ;; [io.github.humbleui.jwm.skija.LayerMetalSkija frame "LayerMetalSkija.java" 27]
  ;; [io.github.humbleui.jwm.Window accept "Window.java" 387]
  ;; [io.github.humbleui.jwm.Window accept "Window.java" 11]]

#+end_src
** profiler http://clojure-goes-fast.com/kb/profiling/clj-async-profiler/
** deps-info
...
or use neil
#+begin_src bash
neil dep add metosin/malli --latest-sha
#+end_src

Also --dry-run

** TODO Lazy maps https://github.com/strojure/zizzmap
** TODO Remote require https://github.com/tonsky/remote-require
** TODO https://github.com/borkdude/grasp
...
** Extracter similar to specter https://github.com/noprompt/meander
...
*** FAILED Trying to load timbre in nbb
#+begin_src
  ----- Error --------------------------------------
Message:  Could not find namespace: goog.i18n.DateTimeFormat
Could not find namespace: goog.i18n.DateTimeFormat
error Command failed with exit code 1.
#+end_src
** Shadow-cljs & NBB
NPM packages https://shadow-cljs.github.io/docs/UsersGuide.html#_using_npm_packages
<2022-09-13 Tue> NBB & shadow modules https://github.com/babashka/nbb/issues/14
<2022-09-13 Tue> subpaths and loading 3rd party libs https://clojurians.slack.com/archives/C6N245JGG/p1662985780223349
<2022-09-13 Tue> ESM module introduction https://clojureverse.org/t/generating-es-modules-browser-deno/6116
<2022-09-13 Tue> NBB :require differences https://clojurians.slack.com/archives/C029PTWD3HR/p1659628557831539
* Gotchas
** nested doseq seems to not sleep correctly

Turns out it was a problem with the midi controller,
...
([:on 100 [:C :E :G]]
 ...
 [:off 100 [:A :C :E]])
  ...
  (defn play! [tune]
  (println "Play!!!!!")
  (doseq [[inst vel notes] tune]
    (let [notes-keys (when notes
                       (walk/postwalk-replace notes-map notes))]
      (println "notes" notes-keys)
      (case inst
        :on (doseq [note-key notes-keys]
              (println "note on")
              (Thread/sleep 50) ;; slight delay in playing each note of the chord.
              (.noteOn chan1 note-key vel))

        :wait (do
                (println "wait " vel)
                (Thread/sleep vel))
        :off (doseq [note-key notes-keys]
               (.noteOff chan1 note-key))))))
#+end_src

https://ask.clojure.org/index.php/3772/nested-doseqs-leak-with-sequence-of-huge-lazy-seqs

** shadow-cljs websocket disconneted

#+begin_src
   WARN  The shadow-cljs Websocket was disconnected.
 ERROR  shadow-cljs - remote-error {"isTrusted": false, "message": "failed to connect to /192.168.64.35 (port 9630) from /10.0.2.16 (port 41302) after 10000ms"}
#+end_src

While react native dev.
Seems to be side stepped provided you are connected to the REPL?

** when-let
#+begin_src clojure
  (when-let [{:keys [a]} {:b 1}]
  (println "I wouldn't have expected this to print but it does..."))
#+end_src
** Can't calculate first argument to def https://stackoverflow.com/questions/50115268/why-doesnt-work-first-argument-to-defn-must-be-a-symbol
** into {} only works for vector tuples https://stackoverflow.com/a/4329616/93074
...
** Core Async
*** Rich hickey talk 2013  https://www.youtube.com/watch?v=yJxFPoxqzWE
*** Rich hickey talk 2014 https://www.youtube.com/watch?v=hMEX6lfBeRM
*** (watch promises vid first inside) https://www.youtube.com/watch?v=yJxFPoxqzWE
*** Async walkthrough (with hot dog machine) https://www.braveclojure.com/core-async/
*** Javascript prep: JS Promises, callbacks, async & await: https://www.youtube.com/watch?v=PoRJizFvM7s
...
*** Unsupported features https://github.com/clojure/core.async/wiki/Go-Block-Best-Practices#unsupported-constructs-and-other-limitations-in-go-blocks
*** Loom as alternative https://www.youtube.com/watch?v=EO9oMiL1fFo
https://clojurians.slack.com/archives/C03S1KBA2/p1667034807468569?thread_ts=1666780466.165799&cid=C03S1KBA2
*** core.async Advice https://medium.com/@hlship/some-observations-about-clojure-core-async-dc0ad44b8e2f
*** Fun example implementing oop core.async https://nvbn.github.io/2015/01/30/reinventing-oop-with-clojure/
*** Internal implementation https://www.braveclojure.com/core-async/
*** core.async & bindings
https://stackoverflow.com/questions/31575866/how-does-the-binding-function-work-with-core-async
https://github.com/twosigma/waiter/issues/204
*** Clojurescript core.async tutorial https://www.learn-clojurescript.com/section-4/lesson-25-intro-to-core-async/
*** Tips

Will freeze and won't print anything if chan size isn't >=1.
#+begin_src clojure
  (defn xxx []
  (let [c (as/chan)]
    (as/>!! c "test")
...
* Interesting reads
** patch testing https://ianthehenry.com/posts/my-kind-of-repl/
** TODO Meander matching parens https://github.com/noprompt/meander/discussions/216
...
** Reloading woes https:/mbdaisland.com/blog/2018-02-09-reloading-woes
...
* Videos & podcasts
** Interceptors!!!! https://www.youtube.com/watch?v=bDN898hu_wQ
** Software rituals (ignore last 10 min crypto bit)
https://www.listennotes.com/podcasts/software-unscripted/software-rituals-with-david-aneDXKg0Mlp/
...
** Clojure experience rewriting
https://podcasts.apple.com/us/podcast/e82-rewrites-with-orestis-markou-part-1/id1461500416?i=1000583914077
** Clojure at Nubank
https://www.infoq.com/podcasts/lucas-cavalcanti-nubank-fintech-clojure/
* Improvements
** TODO Write mock-fn
#+begin_src
    ...
    (is (= expected-extract-and-save-data-for-PEG
           (do
             (dimigi.extraction/extract-and-save-by-letter! mem-test-node
                                                            "P" ;;letter to extract
                                                            (fn [_letter] (slurp mock-tickers-file))
                                                            (fn [ticker] (case ticker "PEG" (slurp mock-PEG-revenue-file) nil)))
             
             (def-macro mock-match)
             (fn [ticker bleh] (match [ticker bleh] ["PEG" true] (slurp  mock-file) :else nil))
             (fn [ticker] (match [ticker] ["PEG"]) (slurp mock-file) :else nil)
             (mock-fn [letter] :else (slurp mock-file))
             (mock-fn [ticker] ["PEG"] (slurp mock-file) :else nil)
             (dimigi.extraction/extract-and-save-by-letter! mem-test-node
                                                            "P" ;;letter to extract
                                                            (fn [_letter] (slurp mock-tickers-file))
                                                            (fn [ticker] (case ticker "PEG" (slurp mock-PEG-revenue-file) nil)))
...
#+end_src
** Ensure that Emacs stacktrace window is colour coded obvious to communicate whether it's a runtime error or compile time error.
...
* Failed experiments
** What was this? Found in 3d print section
...
(defonce rn-logger (.createLogger logger (clj->js config)))

;; Example
;; https://github.com/ptaoussanis/timbre/blob/master/src/taoensso/timbre.cljc#L37
(defn rn-output-fn
  "Default (fn [data]) -> string output fn.
    Use`(partial default-output-fn <opts-map>)` to modify default opts."
  ([     data] (rn-output-fn nil data))
...
* Cool projects
<2022-10-28 Fri> Racing game in react https://github.com/ertugrulcetin/racing-game-cljs
<2022-11-11 Fri> https://max-datom.com/ or the XTDB Space Opera https://nextjournal.com/xtdb-tutorial/start
* Conversations
<2022-12-08 Thu> Reveal https://clojurians.slack.com/archives/C02BJCKN0R4/p1669556096151029
<2023-05-02 Tue> Slurp, chunk, spit (funny clojure names).
* Intend to fund
<2022-12-01 Thu> https://github.com/lambdaisland/kaocha/issues/183
