...
- You can see below that it still alls the generator argument each time to fill out this vector
...
- However, these values are used merely as arguments to a new generators (or a composition of generators) and the user of gen/bind must return this generator.
